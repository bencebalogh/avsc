...
// TODO: Move this module into `types`, deprecate `combine` in favor of
// `Type.combine`.
// TODO: Prefix all module names with `_`, to be more explicit that they
// shouldn't be required directly.
